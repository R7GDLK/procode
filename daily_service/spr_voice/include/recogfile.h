...
std::string recog() 
{
    ...
    char			hints[100]={}; 
    const char* session_id = QISRSessionBegin(NULL, "sub = iat, domain = iat, language = en_us, accent = mandarin, sample_rate = 8000, result_type = plain, result_encoding = utf8, vad_eos=2000", &errcode);//  zh_cn
    long loops;
    int rc;
    int size;
    int dir;
